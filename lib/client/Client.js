...
class Client extends EventEmitter {
    ...
    _registerEvents() {
         ...
         * Don't forget .once if you only want it to fire on join!
         * @event Client#spawn
         */
        forward('spawn');
        ...
        this.bot.on('error', (e)=>{
            ...
            if (errorText.toLowerCase().includes('invalid username or password')) {
                this.emit('error', new Error('Unable to authenticate with Mojang. Your information may be incorrect, or you were rate-limited.'));
                return;
            }
